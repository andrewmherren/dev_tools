<!--
Generated file. Source: docs/mcp-policy.md
...
**URL (fallback):** `http://localhost/docs/sse` (if `.localhost` DNS routing fails on your machine)  
...
**Compatibility Note:**  
If you experience connection issues (for example, local DNS routing failures), try the fallback URL:
